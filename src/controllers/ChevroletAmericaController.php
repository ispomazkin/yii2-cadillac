...
class ChevroletAmericaController extends Controller
{
    ...
    {
        $module = Yii::$app->getModule('chevrolet_america');
        /* @var $module Module*/
        if (!$module)
        ...
        Yii::setAlias('@chevrolet_views', Yii::getAlias('@ispomazkin/chevrolet_america/views/chevrolet'))	;
    ...
    {
        $url = $this->api_host.'/chevrolet/get-america-years';
    ...
    protected function createSeo($type,$data)
    {
        ...
        switch($type)
        {
            ...
            case 'categories':
                $this->view->params['breadcrumbs'][] =  ['label'=>$this->titlePattern['years'],'url'=>Url::to(['chevrolet-america/index'])];
                break;

            case 'groups':
                $this->view->params['breadcrumbs'][] =  ['label'=>$this->titlePattern['years'],'url'=>Url::to(['chevrolet-america/index'])];
                $this->view->params['breadcrumbs'][] =  ['label'=>$this->titlePattern['categories'],'url'=>Url::to(['chevrolet-america/categories',
            ...
            case 'parts' :
                ...
                $this->view->params['breadcrumbs'][] = [
                    ...
                    'url' => Url::to(['chevrolet-america/groups','year_url'=>$data['model_url'],'category_url'=>$data['category_url'],
                    ])
                ];
    ...
    {
        $url = $this->api_host.'/chevrolet/get-america-categories?url='.$year_url;
        $data = Json::decode($this->sendRequest($url));
    ...
    {
        $url = $this->api_host.'/chevrolet/get-america-groups?year_url='.$year_url.'&category_url='.$category_url;
    ...
    {
        $url = $this->api_host.'/chevrolet/get-america-parts?year_url='.$year_url.'&last_url='.$last_url;
